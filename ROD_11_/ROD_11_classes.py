...
class RectangleImage96:
    def __init__(self, width_px, height_px, dpi=300, font_name="arialbd.ttf", border_thickness=5,
                 border_color="black"):
        self.dpi = dpi
        ...
        # Tworzenie obrazu o podanej szerokości i wysokości
        self.total_width = self.width_px  # Korekta szerokości
        self.image = Image.new("RGB", (self.total_width, self.height_px), "white")
        self.draw = ImageDraw.Draw(self.image)
        self.font_name = font_name
        self.rectangle_count = 0  # Inicjalizacja licznika prostokątów
    ...
    def add_border(self):
        # Rysowanie prostokąta jako obramowanie
        self.draw.rectangle(
            [(self.border_thickness // 2, self.border_thickness // 2),
             (self.total_width - self.border_thickness // 2, self.height_px - self.border_thickness // 2)],
    ...
    def expand_image(self, rect_width_px):
        ...
        # Rysowanie obramowania ponownie po powiększeniu obrazu
        self.add_border()
    ...
    def add_rectangle(self, text="Gold", rect_width_mm=None, font_size_center=20):
        ...
        self.draw.text((center_x - text_width // 2, center_y - text_height // 2), text, fill="black",
                       font=font_center)
